 ...
 */
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'indexed' );  cryout_schema_microdata('article'); ?>>
<?php cryout_featured_hook(); ?>
	...
	<?php cryout_post_title_hook(); ?>
		...
		<h2 class="entry-title" <?php cryout_schema_microdata('entry-title'); ?>>
			<span class="entry-format"><i class="icon-video-camera" title="<?php _e( 'Video', 'verbosa' ); ?>"></i></span>
