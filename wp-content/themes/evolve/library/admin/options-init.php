...
$evolve_imagepath = get_template_directory_uri() . '/library/functions/images/';
...
Redux::setArgs($evolve_opt_name, array(
    ...
    'intro_text' => '<a href="' . $evolve_t4p_url . 'evolve-multipurpose-wordpress-theme/" title="Theme Homepage" target="_blank"><i class="t4p-icon-appbarhome"></i> Theme Homepage</a><a href="' . $evolve_t4p_url . 'docs/" title="Documentation" target="_blank"><i class="t4p-icon-appbarpagetext"></i> Documentation</a><a href="' . $evolve_t4p_url . 'support-forums/" title="Support" target="_blank"><i class="t4p-icon-appbarlifesaver"></i> Support</a><a href="' . $evolve_fb_url . '" title="Facebook" target="_blank"><i class="t4p-icon-appbarsocialfacebook"></i> Facebook</a>',
));
    ...
    'fields' => array(
        ...
        array(
            ...
            'options' => array(
                ...
                'pattern_1.png' => $evolve_imagepathfolder . '/pattern/pattern_1_thumb.png',
                'pattern_2.png' => $evolve_imagepathfolder . '/pattern/pattern_2_thumb.png',
                'pattern_3.png' => $evolve_imagepathfolder . '/pattern/pattern_3_thumb.png',
                'pattern_4.png' => $evolve_imagepathfolder . '/pattern/pattern_4_thumb.png',
                'pattern_5.png' => $evolve_imagepathfolder . '/pattern/pattern_5_thumb.png',
                'pattern_6.png' => $evolve_imagepathfolder . '/pattern/pattern_6_thumb.png',
                'pattern_7.png' => $evolve_imagepathfolder . '/pattern/pattern_7_thumb.png',
                'pattern_8.png' => $evolve_imagepathfolder . '/pattern/pattern_8_thumb.png',
            ),
...
Redux::setSection($evolve_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'subtitle' => __('Background color of top menu for Header #4', 'evolve'),
